...
class Simulator(val taskSupport: TaskSupport, val timeStats: TimeStatistics):
  ...
  def mergeBoundaries(a: Boundaries, b: Boundaries): Boundaries =
    val finalBoundaries = new Boundaries()
    finalBoundaries.maxX = a.maxX.max(b.maxX)
    finalBoundaries.maxY = a.maxY.max(b.maxY)
    finalBoundaries.minX = a.minX.min(b.minX)
    finalBoundaries.minY = a.minY.min(b.minY)
